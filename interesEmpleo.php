...
$idEmpleo = empty($_REQUEST['idEmpleo']) ? '' : $_REQUEST['idEmpleo'];
...
$cuerpo = "El alumno <b>$a, $n</b>, con mail <i>$m</i> ha mostrado interés en el empleo <b>$nombre</b>.";
$asunto = 'Interés en empleo - Graduados APP';
