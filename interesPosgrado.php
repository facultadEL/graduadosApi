...
$idPosgrado = empty($_REQUEST['idPosgrado']) ? '' : $_REQUEST['idPosgrado'];
...
$cuerpo = "El alumno <b>$a, $n</b>, con mail <i>$m</i> ha mostrado interés en el posgrado <b>$nombre</b>.";
$asunto = 'Interés en posgrado - Graduados APP';
